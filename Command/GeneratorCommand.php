...
abstract class GeneratorCommand extends ContainerAwareCommand
{
    ...
    protected function getSkeletonDirs(BundleInterface $bundle = null)
    {
        ...
        if (isset($bundle) && is_dir($dir = $bundle->getPath().'/Resources/eZStudioBlockGeneratorBundle/skeleton')) {
            $skeletonDirs[] = $dir;
        }

        if (is_dir($dir = $this->getContainer()->get('kernel')->getRootdir().'/Resources/SeZStudioBlockGeneratorBundle/skeleton')) {
            $skeletonDirs[] = $dir;
        }
